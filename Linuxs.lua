...
local Linux = {}
Linux.CurrentTheme = "Red"
Linux.SelectedTheme = "Red"
Linux.Themes = {
...
Linux.FrameTransparency = 0.6
Linux.FrameColor = Color3.fromRGB(23, 23, 23)
Linux.MainFrameColor = Color3.fromRGB(8, 8, 8)
...
function Linux.LoadThemeSettings()
    local success, result = pcall(function()
        if readfile and isfile(Linux.ConfigFolder .. "/theme.json") then
            ...
            Linux.CurrentTheme = themeData.Theme or "Red"
...
function Linux.Create(config)
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Button(config)
            ...
            local HoverEffect = Linux.Instance("Frame", {
                Parent = BtnFrame,
            ...
            Btn.MouseEnter:Connect(function()
                ...
                TweenService:Create(HoverEffect, TweenInfo.new(hoverDuration, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                    Size = UDim2.new(1, 0, 1, 0),
            ...
            Btn.MouseLeave:Connect(function()
                TweenService:Create(BtnFrame, TweenInfo.new(0.2), {BackgroundTransparency = Linux.FrameTransparency}):Play()
                TweenService:Create(HoverEffect, TweenInfo.new(hoverDuration, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                    Size = UDim2.new(0, 0, 1, 0),
                    BackgroundTransparency = 1
                }):Play()
            ...
            Btn.MouseButton1Up:Connect(function()
                ...
                task.spawn(function()
                    ...
                    TweenService:Create(Btn, TweenInfo.new(0.1), {TextColor3 = originalTextColor}):Play()
                end)
            end)
